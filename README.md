...
journey
    ...
    section Инициализация сессии
      style Инициирует сессию для диагностики fill:#f9f,stroke:#333,stroke-width:4px;font-size:18px
    ...
    section Диагностика
      style Запускает программную диагностику fill:#f9f,stroke:#333,stroke-width:4px;font-size:18px
    ...
    section Исправление ошибок
      style Выбирает исправление обнаруженных ошибок fill:#f9f,stroke:#333,stroke-width:4px;font-size:18px
    ...
    section Генерация отчета
      style Запрашивает генерацию отчета fill:#f9f,stroke:#333,stroke-width:4px;font-size:18px
    ...
    section Выход из системы
      style Выходит из системы fill:#f9f,stroke:#333,stroke-width:4px;font-size:18px
