...
journey
    ...
    section Регистрация и вход
      ...
      Действие: Пользователь подтверждает регистрацию через email: 4: Пользователь
      Действие: Пользователь входит в систему с учетными данными: 5: Пользователь
      Действие: Пользователь получает уведомление о успешном входе: 5: Система

    section Инициализация сессии
      Действие: Пользователь инициирует сессию для диагностики: 5: Пользователь
      Действие: Система инициализирует сессию и проверяет доступ: 4: Система
      Действие: Пользователь получает доступ к диагностическим инструментам: 5: Пользователь

    section Диагностика
      Действие: Пользователь запускает программную диагностику: 4: Пользователь
      Действие: Система выполняет программную диагностику: 3: Система
      Действие: Пользователь просматривает результаты программной диагностики: 4: Пользователь
      Действие: Пользователь запускает аппаратную диагностику: 4: Пользователь
      Действие: Система выполняет аппаратную диагностику: 3: Система
      Действие: Пользователь просматривает результаты аппаратной диагностики: 4: Пользователь

    section Исправление ошибок
      Действие: Пользователь выбирает исправление обнаруженных ошибок: 4: Пользователь
      Действие: Система исправляет программные ошибки: 3: Система
      Действие: Пользователь получает уведомление об исправлениях: 5: Система
      Действие: Пользователь выбирает исправление аппаратных ошибок: 4: Пользователь
      Действие: Система исправляет аппаратные ошибки: 3: Система
      Действие: Пользователь получает уведомление об исправлениях: 5: Система

    section Генерация отчета
      Действие: Пользователь запрашивает генерацию отчета: 4: Пользователь
      Действие: Система генерирует отчет: 3: Система
      Действие: Эксперт редактирует отчет: 4: Эксперт
      Действие: Отчет сохраняется в системе: 5: Система
      Действие: Пользователь получает уведомление о готовности отчета: 5: Система

    section Выход из системы
      Действие: Пользователь выходит из системы: 5: Пользователь
      Действие: Система завершает сессию и выводит уведомление: 4: Система
